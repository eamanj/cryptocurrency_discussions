...
parser.add_argument("-hd", "--history_days", type=int, default = -1,
                    ...
                    "prior to earliest trade date of the coin that are used for counting "
                    "the coin mentions. For example, value of 7 means that only posts "
                    "within the 7 days prior to the coin earliest trade date are used "
                    "to count coin mentions by each user. Default is a negative value "
                    "which indicates an unlimited number of days.")
