...
parser = argparse.ArgumentParser(
    ...
    'undirected network per date.  We will take snapshot of the network whenever we '
...
if __name__ == '__main__':
  ...
  subject_contributors = collections.defaultdict(
  ...
  with open(args.forum_input, mode='r') as infile:
    ...
    for input_row in reader:
      ...
      (subject_contributors[full_subject_id]).append(user)
